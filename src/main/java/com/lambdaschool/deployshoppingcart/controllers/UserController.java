...
public class UserController
{
    ...
    /**
     * Given a complete User Object Given the user id, primary key, is in the User table, replace the User record and
     * Useremail records. Roles are handled through different endpoints
     * <br> Example: <a href="http://localhost:2019/users/user/15">http://localhost:2019/users/user/15</a>
     *
     * @param updateUser A complete User including all emails and roles to be used to                   replace the
     ...
     * affected. Roles are handled through different endpoints If an email list is given, it replaces the original emai
     * list.
