...
public interface UserService
{
    ...
    /**
     * Given a complete user object, saves that user object in the database. If a primary key is provided, the record is
     ...
     * <p>
     * Regarding Role and Useremail items, this process only allows adding those. Deleting and editing those lists is
     * done through a separate endpoint.
     *
