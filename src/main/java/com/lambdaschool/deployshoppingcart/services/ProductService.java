...
public interface ProductService
{
    ...
    /**
     * Given a complete Product object, saves that Product object in the database. If a primary key is provided, the
     * record is completely replaced If no primary key is provided, one is automatically generated and the record is
     ...
     * @param product The product object containing the new information - only the product can be updated here, no
     *                carts!
